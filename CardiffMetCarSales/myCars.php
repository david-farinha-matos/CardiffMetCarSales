...
<body>
    ...
    <main class="container" style="width: auto; height: auto;">
        ...
        <div class="navBar" id="myTopnav">
            ...
            <a href="http://CardiffMetCarSales/myCars" class="currentPage">My Cars</a>
                    ...
                    ?>
                        <section class="row col-12">
                            <div class="col-sm-4">
                                ...
                                $path = "userImages\\$username-Cars\\carPicture1";
                                $files = opendir($path);
                                if ($files) {
                                    while (($fileName = readdir($files)) == true) {
                                        if ($fileName != '.' && $fileName != '..') {
                                            $photo = "http://CardiffMetCarSales/userImages/" . $username . "-Cars/carPicture1/" . $fileName;
                                        }
                                    }
                                }
                                ?>
                            ...
                            <div class="col-sm-2">
                                <a style="font-size: 2.3em; text-align: center;" href="editCar.php?vehicle_id=<?php echo $row['vehicle_id'] ?>"> Edit </a><br>
                            </div>
                            <div class="col-sm-2">
                                <a style="font-size: 2.3em; text-align: center;" href="deleteCar.php?vehicle_id=<?php echo $row['vehicle_id'] ?>"> Delete </a>
                            </div>
                        </section>
                    <?php
                    } // end while loop
